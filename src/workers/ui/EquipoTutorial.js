...
export function initTutorialEquipo() {
    ...
    wrap.innerHTML = `
        <div class="tutorial-drag-bar" id="tutorial-drag-bar-equipo" title="Arrastrá para mover"><i class="fas fa-grip-vertical"></i> <span>Arrastrá el video para moverlo</span></div>
