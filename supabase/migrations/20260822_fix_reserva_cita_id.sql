-- ============================================================
-- MIGRACIÓN: Fix colisión de cita_id en reservar_cita
-- Fecha: 2026-08-21
--
-- El id de cita se generaba como epoch ms puro. En reservar_citas_bulk
-- dos items procesados en el mismo milisegundo generaban el MISMO id
-- → violación de citas_pkey y el carrito completo fallaba.
--
-- Fix: epoch ms + sufijo aleatorio de 4 hex. El id sigue siendo un
-- string opaco para el frontend (todas las comparaciones son String).
--
...
SELECT '[RESERVA] Fix aplicado: cita_id con sufijo único' AS status;
