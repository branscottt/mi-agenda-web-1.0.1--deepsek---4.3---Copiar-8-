...
export function initTutorialCompartir() {
    ...
    wrap.innerHTML = `
        <div class="tutorial-drag-bar" id="tutorial-drag-bar-share" title="Arrastra para mover"><i class="fas fa-grip-vertical"></i> <span>Arrastra el video para moverlo</span></div>
