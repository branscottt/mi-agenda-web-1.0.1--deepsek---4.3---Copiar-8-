...
export function initTutorialNotificaciones() {
    ...
    wrap.innerHTML = `
        <div class="tutorial-drag-bar" id="tutorial-drag-bar-notif" title="Arrastrá para mover"><i class="fas fa-grip-vertical"></i> <span>Arrastrá el video para moverlo</span></div>
